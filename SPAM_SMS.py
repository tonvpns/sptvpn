...
os.system(f'cls & mode 90,30 & title Movie Shop')
...
╚═════════════════════════════════════════════════════════════════════════════════╣
    ...
    print("")
    print("")
    phone = input(f"{Color.red}Number: >>> ")
    count = int(input(f"{Color.red}quantity: >>> "))
    print()
    sleep(1)
    ...
    def trueh():
        try:
            ...
            print(receive_color() + f'[{now()}] FAST SLEEP')
        except:pass
